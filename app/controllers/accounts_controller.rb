class AccountsController < ApplicationController
  ...
  private
    ...
    def account_params
      params.require(:account).permit(:account_status, :account_status_date, :conversation_status, :stripe_customer_id, :stripe_payment_method, :stripe_payment_method_card_country)
    end
end
