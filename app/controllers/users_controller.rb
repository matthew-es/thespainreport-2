class UsersController < ApplicationController
	...
	def index
		if current_user.nil? 
			...
			@users0 = User.patrons.where(level_amount: 0).count
			@users1 = User.patrons.where(level_amount: 1)
			@users2 = User.patrons.where(level_amount: 2).count
			@users3 = User.patrons.where(level_amount: 3).count
			@users4 = User.patrons.where(level_amount: 4).count
			@users5 = User.patrons.where(level_amount: 5).count
			@users6 = User.patrons.where(level_amount: 6).count
			@users7 = User.patrons.where(level_amount: 7).count
			@users8 = User.patrons.where(level_amount: 8).count
			@users9 = User.patrons.where(level_amount: 9).count
			@users10 = User.patrons.where(level_amount: 10).count
			@users11 = User.patrons.where(level_amount: 11).count
			@users12 = User.patrons.where(level_amount: 12).count
