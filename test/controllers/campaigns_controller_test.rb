...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { language_id: @campaign.language_id, teaser: @campaign.teaser } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { language_id: @campaign.language_id, teaser: @campaign.teaser } }
